...
Kreading = document.querySelector(".more1btn")
Kreading.addEventListener("click", () => {
    window.location.href = "2_KeepReadingSection.html";
})



function BackHome(){
    window.location.href = "1_FirstIntro.html";
}